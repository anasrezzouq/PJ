            ...
            <div class="pt-24">
                <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                  ...
                  <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <p class="uppercase tracking-loose w-full text-black">Voulez-vous parcourir des articles de haute qualité?</p>
                    <h1 class="my-4 text-5xl font-bold leading-tight text-black">
                        Découvrez ce qui vous passionne, à votre façon
                    </h1>
